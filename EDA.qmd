...
This communicates to us that people with diabetes do not have a higher proportion of heavy drinkers who smoke than those without diabetes. Maybe these two variables re not useful in predicting diabetes status.
...
Looking at whats needed for the API section of this project I ran the following addition contingency tables to find the most prevalent classes for categorical variables.
...
I think **HighBP**, **HighChol**, **BMI**, **Age**, and **GenHlth** will be useful in predicting diabetes status while **Sex**, **Smoker**, and **HvyAlchoholConsump** will not. I will thus being using those five predictors in my modeling!
